...
@section('content')
    ...
    <div class="flex">
      <h1 class="flex__title flex__title--responsive">About our juice!</h1>
      <p class="flex__text flex__text--responsive">
        ...
        <br><br>
        <h3 class="flex__text flex__text--responsive">20-Day($15 a day) &nbsp &nbsp 30-Day($12 a day)</h3>
        <br><br>
      <p class="flex__text flex__text--responsive">
    ...
    <div class="flex">
      ...
      <p class="flex__text flex__text--responsive">
        ...
        <br><br>
        <h3 class="flex__text flex__text--responsive">Packages: (for 3 days)</h3>
        <br><br>
        <h3 class="flex__text flex__text--responsive">3 meals or 6 meals</h3>
        <br><br>
        <h3 class="flex__text flex__text--responsive">(Each meal costs $10.50, plus a $6 service fee per 3 meals [one-time fee]-reusable containers)</h3>
        <br><br>
      <p class="flex__text flex__text--responsive">
